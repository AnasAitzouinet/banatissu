...
var render = function render() {
  ...
  return _c("div", {
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: _vm.currentUserPermissions && (_vm.currentUserPermissions.includes("products_add") || _vm.currentUserPermissions.includes("products_view") || _vm.currentUserPermissions.includes("barcode_view") || _vm.currentUserPermissions.includes("brand") || _vm.currentUserPermissions.includes("unit") || _vm.currentUserPermissions.includes("count_stock") || _vm.currentUserPermissions.includes("colors")),
    ...
    directives: [{
      ...
      _vm.currentUserPermissions.includes("warehouse") || _vm.currentUserPermissions.includes("backup") || _vm.currentUserPermissions.includes("currency") || _vm.currentUserPermissions.includes("permissions_view")),
    ...
    staticClass: "item-name"
  }, [_vm._v(_vm._s(_vm.$t("Colors")))])])], 1) : _vm._e(), _vm._v(" "), _vm.currentUserPermissions && _vm.currentUserPermissions.includes("brand") ? _c("li", {
    staticClass: "nav-item"
  }, [_c("router-link", {
    attrs: {
      tag: "a",
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "title-lang"
  }, [_vm._v("Arabic")])])])])], 2)], 1), _vm._v(" "), _c("div", {
    staticClass: "dropdown"
  }, [_c("b-dropdown", {
