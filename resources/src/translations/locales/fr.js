...
export default {
    ...
    notes: 'Notes',
    balance: 'Solde',
    Choose_Color:'Choose Couleur',
    Enter_Code_color:'Entrez Code Couleur',
    Codecolor:'Code Couleur',
    Create_Color:'Créer Couleur',
    Namecolor:'Nom Couleur',
    Enter_name_color:'Entrez Nom Couleur',
    Receipt:'Reçu',
    ...
    Choose_Brand: 'Choisissez la Marque/Industrie',
    ...
    Enter_Name_Brand: 'Entrez le nom de la Marque/Industrie',
    Enter_Description_Brand: 'Entrez la description de la Marque/Industrie',
    ...
    All_Brand: 'Toute Marque/Industrie',
    ...
    pieces_count_optional: 'Nombre de Pièces (Optionnel)',
    ...
    BrandManager: 'Gestion de la Marque/Industrie',
    BrandImage: 'Image de Marque/Industrie',
    BrandName: 'Nom de Marque/Industrie',
    BrandDescription: 'Description de la Marque/Industrie',
    ...
    ListofBrand: 'Liste des Marques/Industries',
    ...
    Delete: {
        ...
        TitleBrand: 'Cette Marque/Industrie a été supprimée',
    ...
    Create: {
        TitleBrand: 'Cette Marque/Industrie a été créée',
