<template>
  <div class="main-content">
    <breadcumb :page="$t('Colors')" :folder="$t('Products')"/>
        ...
        <b-form @submit.prevent="Submit_Category">
          <b-row>
            ...
            <b-col md="12">
              ...
              >
                <b-form-group :label="$t('Codecolor') + ' ' + '*'">
                  <b-form-input
                    :placeholder="$t('Enter_Code_color')"
            ...
            <b-col md="12">
              <validation-provider
                ...
                v-slot="validationContext"
              >
                <b-form-group :label="$t('Namecolor') + ' ' + '*'">
                  <b-form-input
                    :placeholder="$t('Enter_name_color')"
                    :state="getValidationState(validationContext)"
...
export default {
  ...
  computed: {
    columns() {
      return [
        {
          label: this.$t("Codecolor"),
          field: "code",
          tdClass: "text-left",
          thClass: "text-left"
        },
        {
          label: this.$t("Namecolor"),
          field: "name",
          tdClass: "text-left",
          thClass: "text-left"
        },
